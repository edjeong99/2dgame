window.addEventListener('load', function(){
    ...
    if (this.powerUp){
        ...
        draw(context){ 
            ...
            context.drawImage(this.image, this.frameX * this.width, this.frameY * this.height, this.width, this.height, this.x, this.y, this.width,this.
                height);
            }
        shootTop(){
                 if (this.game.ammo > 0){
...
class Layer{
    ...
    update(){
        if(this.x <= this.height) this.x = 0;
...
class Background{
    constructor(game){
        ...
        this.layer4 = new Layer(this.game,this.image1, 1);
    ...
    class UI{
        ...
        if (this.game.gameOver){
            ...
            context.font = '70px' + this.fonFamily;
            context.fillText(message1, this.game.width * 0.5, this.game.height * 
                0.5 - 20);
            context.font = '25px' + this.fonFamily;
            context.fillText(message2, this.game.width * 0.5, this.game.height * 
                0.5 + 20);
        }
        //ammo
        if (this.game.player.powerUp) context.fillStyle = '#E6E6FA';
    ...
    class Game{
        ...
        addEnemy(){
            ...
            (this));
            else if(randomize < 0.8)this.enemies.push(new HiveWhale
            (this));
